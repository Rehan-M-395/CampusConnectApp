...
const listGatePasses = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const records = yield services_1.GatePassService.listGatePasses();
...
const listGuardHistory = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const records = yield services_1.GatePassService.listGuardHistory(guardErpId);
...
const scanGatePass = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const record = yield services_1.GatePassService.scanGatePass(qrValue, guardErpId, guardName);
...
const markGatePassIn = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const record = yield services_1.GatePassService.markIn(req.params.id);
...
const markGatePassOut = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const record = yield services_1.GatePassService.markOut(req.params.id);
