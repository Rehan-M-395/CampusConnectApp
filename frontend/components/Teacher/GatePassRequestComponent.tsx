...
export default function GatePassRequestComponent({ teacherId, teacherName }: Props) {
  ...
  const validateForm = (): boolean => {
    ...
    if (!persons.trim() || isNaN(parseInt(persons))) {
    ...
    const selectedDateObj = new Date(date.split('/').reverse().join('-')); // Convert DD/MM/YYYY to YYYY-MM-DD
    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.instruction}>
          Fill in the details of visitors/parents for gate pass generation
        </Text>
        ...
        <View style={styles.formGroup}>
          ...
          <TextInput
            placeholder="e.g., 3001234567 (10 digits)"
            placeholderTextColor={GRAY_TEXT}
            style={styles.input}
      ...
      {showQR && qrData && (
        <View style={styles.qrCard}>
          ...
          <Text style={styles.qrInfo}>
            Share this QR code with {formData.name}
          </Text>
